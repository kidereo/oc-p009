...
import {card} from "../containers/Dashboard";
...
describe('Given I am connected as an Admin', () => {
    ...
    //TEST EDITED AFTER [Bug Hunt] - Dashboard RESOLUTION
    describe('When I am on Dashboard page and I click on arrow', () => {
        test('Then, tickets list should be unfolding, and cards should appear', async () => {
            ...
            //First, set this model to access getByTestId() in the dashboard DOM for arrow-iconX test-ids.
            ...
            //Second, set this model to access getByTestId() in the cards DOM for open-xxxx test-ids.
    ...
    describe('When I am on Dashboard page and I click on edit icon of a card', () => {
        test('Then, right form should be filled', () => {
             ...
             */
            //Set this model to access getByTestId() in the cards DOM for open-xxxx test-id.
            document.body.innerHTML = cards(bills);
            ...
            /**
             * NOTE: The below block, although present in the original codebase, will cause the test to fail once the card click issue is fixed.
             */
            /*document.body.innerHTML = DashboardUI({data: {bills}})
            const handleShowTickets1 = jest.fn((e) => dashboard.handleShowTickets(e, bills, 1))
            const icon1 = screen.getByTestId('arrow-icon1')
    ...
    describe('When I am on Dashboard page and I click 2 times on edit icon of a card', () => {
        test('Then, big bill Icon should Appear', () => {
            ...
            //Second, set this model to access getByTestId() in the dashboard DOM for the big-billed-icon test-id.
            document.body.innerHTML = DashboardUI({data: {bills}});
